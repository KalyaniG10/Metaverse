...
const directiona_light = new THREE.DirectionalLight( 0xffffff, 1 );
ambient_light.add(directiona_light);
...
//const material_cone = new THREE.MeshPhongMaterial( {color: 0x1eeff0} );
...
function mintNFT(){
  ...
  if(typeof window.ethereum == "undefined") {
   ...
   let contract =new web3.eth.Contract(abi,"0x7A1cd76d7295f4DBBC4D8aa7F1eCe35d133E289b");
...
//contract address =0x7A1cd76d7295f4DBBC4D8aa7F1eCe35d133E289b